...
type ExportDialogParam = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

type ExportDealListParams = {
  status?: string;
  startDate: string;
  endDate: string;
}
...
type PurchaseTransactionExportParam = {
  dealName?: string;
  dealId?: string;
  transactionId?: string;
  purchaseId?: string;
