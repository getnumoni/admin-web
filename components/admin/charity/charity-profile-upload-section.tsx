...
interface CharityProfileUploadSectionProps {
  onImageChange: (imageUrl: string | null) => void;
  imageUrl: string;
}

export default function CharityProfileUploadSection({
  onImageChange,
  imageUrl
}: CharityProfileUploadSectionProps) {
  ...
  return (
    <div className="p-6 border-b border-gray-200">
      <div className="flex flex-col items-start">
        ...
        <button
          type="button"
          onClick={() => document.getElementById('charity-profile-upload')?.click()}
